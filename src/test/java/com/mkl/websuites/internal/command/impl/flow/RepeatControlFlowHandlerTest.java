...
public class RepeatControlFlowHandlerTest {
    ...
    public void shouldNotPassValidationTimesValueIncorrect(String timesValue) {
        ...
        sut = new RepeatControlFlowHandler(params);
        // and
        expectedException.expect(WebSuitesException.class).hasMessageContaining("must be proper integer value");
        // when
        sut.run();
    ...
    public void shouldNotPassValidationTimesValueNotInRange() {
        ...
        sut = new RepeatControlFlowHandler(params);
        // and
        expectedException.expect(WebSuitesException.class).hasMessageContaining("Integer value for param")
    ...
    @Parameters({"com.mkl.websuites.internal.command.impl.validator.SampleDataProvider, true",
    ...
    @Test
    public void shouldDoRepeatDataProvider(@Mocked final Command command,
            @Mocked final WebSuitesUserProperties mockedProps) {
        // given
        Map<String, String> params = new HashMap<String, String>();
        params.put("dataProvider", "com.mkl.websuites.internal.command.impl.validator.SampleDataProvider");
        sut = new RepeatControlFlowHandler(params);
        sut.setNestedCommands(Arrays.asList(command));
        // and
    ...
    @Test
    public void shouldRepeatWithInlineDataWithPropertyValueCheck(@Mocked final Command command,
            @Mocked final WebSuitesUserProperties mockedProps) {
        // given
        Map<String, String> params = new HashMap<String, String>();
        params.put("data", "1,2,3;4,5,6;7,8,9");
    ...
    private void inlineExpectedData(final Command command, final WebSuitesUserProperties mockedProps, String param1,
    ...
    @Test
    public void shouldRepeatWithInlineDataWithInlinePropertyNames(@Mocked final Command command,
            @Mocked final WebSuitesUserProperties mockedProps) {
        // given
        Map<String, String> params = new HashMap<String, String>();
        params.put("data", "1,2,3;4,5,6;7,8,9");
    ...
    private static boolean flagForHandlerInvocationMarker; // a bit dirty, but I see no mocking
                                                           // here...
    ...
    @Test
    public void shouldRunForDdlParam(@Mocked final Command command, @Mocked final WebSuitesUserProperties mockedProps) {
        // given
        Map<String, String> params = new HashMap<String, String>();
        params.put("subtest", "true");
        params.put("data", "1,2,3;x,y,z;p,q,r;v1,v2,v3");
