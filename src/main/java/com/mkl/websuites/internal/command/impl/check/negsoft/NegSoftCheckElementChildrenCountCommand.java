...
public class NegSoftCheckElementChildrenCountCommand extends NegCheckElementChildrenCountCommand {
    ...
    public NegSoftCheckElementChildrenCountCommand(Map<String, String> parameterMap) {
        super(parameterMap);
    }

    public NegSoftCheckElementChildrenCountCommand(String selector, Integer expectedNumberOfElements) {
