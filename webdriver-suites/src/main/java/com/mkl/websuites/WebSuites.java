 ...
 * <p>This annotation allows to define test suites and browsers to run these tests against.</p>
 * <p>Sample configuration might look like:</p>
 * <code>
...
public @interface WebSuites {
     ...
     * <p>The elements of this list are string identifiers of browsers, like "<b>ff</b>" or "<b>chrome</b>".</p>
     * that come from {@link com.mkl.websuites.config.BrowserConfig{ annotation.
     * <p>By default three identifiers are available:</p>
     * <ul>
     *      <li><b>ff</b> for default FireFox driver</li>
     *      <li><b>html</b> for HtmlUnitDriver</li>
     *      <li><b>none</b> for non-browser tests</li>
     * </ul>
     * <p>For custom browser definitions which use explicit web drivers please specify a corresponding element in
     * the <code>browserConfiguration</code> element</p>
     */
    String[] browsers() default {};

//    String browsersPropertyName() default ""; 

    /**
     * Use this attribute to define folder path from which all scenario files will be run.
     * <p>You can specify more than one paths.</p>
     * <p>Each folder is specified using {@link com.mkl.websuites.config.Folder} annotation.</p>
     * <p>Example usage:</p>
     * <code>
     ...
     * <p>You can specify more than one files.</p>
     * <p>Each folder is specified using {@link com.mkl.websuites.config.ScenarioFile} annotation.</p>
     * <p>Example usage:</p>
     * <code>
     ...
     * <p>You can specify more than one test class.</p>
     * <p>Each test class is specified using {@link com.mkl.websuites.config.TestClass} annotation.</p>
     * <p>Example usage:</p>
     * <code>
    ...
    /**
     * You can specify main site configuration here. In the {@link com.mkl.websuites.config.SiteConfig} annotation you
     * can specify server host, port and base address. Then, in your tests you can access this information using
     * properties:
     * <ul>
     ...
     * </ul>
     * <p>The most commonly used setting is <code>waitTimeout</code>, which sets the global
     * timeout for all implicit WebDriver waits.</p>
     */
    SiteConfig site() default @SiteConfig;

    /**
     * Specifies browsers that can be used in multi-browser tests.
     * <p>Each browser is specified using {@link com.mkl.websuites.config.BrowserConfig} annotation, which
     * determines browser local ID, dipslay name and web driver physical location.
     * </p>By default the FireFox browser is available so if installedo on the OS it will work out-of-the-box.<p>
     * <p>Sample configuration of custom browser:</p>
    ...
    /**
     * If there are multiple WebSuites runner classes, you can share browser configuration between them and avoid
     * specifying them in each runner separately. Use this class to point to a class which holds 
     * {@link com.mkl.websuites.config.BrowserDefinition} annotation.
     * <p>If both <code>browserConfiguration</code> and <code>browserResusableConfiguration</code> are specified,
     * then the browser configuration is merged with a priority to <code>browserConfiguration</code> 
