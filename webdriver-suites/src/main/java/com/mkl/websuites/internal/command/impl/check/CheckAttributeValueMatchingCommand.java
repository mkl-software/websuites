...
public class CheckAttributeValueMatchingCommand extends CheckAttributeValueCommand {
    ...
    protected void runSingleStringAssertion(StringAssert assertion, String string) {
        ...
        assertion.overridingErrorMessage(
                "The attribute with value matching '%s' is expected to appear somewhere on the page "
