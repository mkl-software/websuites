...
public class CheckSelectOptionTextContainingCommand extends
		CheckSelectOptionTextCommand {

	public CheckSelectOptionTextContainingCommand(
			Map<String, String> parameterMap) {
		super(parameterMap);
	}

	public CheckSelectOptionTextContainingCommand(String selector,
			String expectedText) {
