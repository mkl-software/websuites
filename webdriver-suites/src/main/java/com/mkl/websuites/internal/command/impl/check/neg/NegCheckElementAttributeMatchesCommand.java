...
public class NegCheckElementAttributeMatchesCommand extends CheckElementAttributeMatchesCommand {
    ...
    public NegCheckElementAttributeMatchesCommand(Map<String, String> parameterMap) {
        super(parameterMap);
    }
        ...
        protected void runSingleStringAssertion(StringAssert assertion, String elementText) {
            ...
            assertion.overridingErrorMessage(
                    "Expecting value of attribute '%s' in the web page element with selector '%s'"
                            + " NOT to match regexp '%s', but found '%s'", inputAttributeName, by,
                    expectedAttributeValue, foundElement.getAttribute(inputAttributeName)).doesNotMatch(
