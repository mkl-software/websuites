...
public class SoftCheckElementAttributeValueContainsCommand extends
		CheckElementAttributeValueContainsCommand {

	public SoftCheckElementAttributeValueContainsCommand(
			Map<String, String> parameterMap) {
		super(parameterMap);
	}

	public SoftCheckElementAttributeValueContainsCommand(String selector,
