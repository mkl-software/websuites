...
public class CheckElementInnerHtmlMatchesCommand extends CheckElementInnerHtmlCommand {

    public CheckElementInnerHtmlMatchesCommand(Map<String, String> parameterMap) {
        super(parameterMap);
    }

    public CheckElementInnerHtmlMatchesCommand(String selector, String expectedText) {
