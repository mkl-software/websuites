...
public interface RepeatDataProvider {
	 ...
	 * 
	 * TODO: usually it will bring data overhead, because parameter names will be
	 * the same across all data rows. Think how to represent this more efficiently
	 * in the returning type.
	 * @return
	 */
