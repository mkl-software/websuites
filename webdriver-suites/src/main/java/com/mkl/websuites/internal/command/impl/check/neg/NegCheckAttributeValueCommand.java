...
public class NegCheckAttributeValueCommand extends CheckAttributeValueCommand {
	...
	protected void runSingleStringAssertion(StringAssert assertion,
		...
		assertion
			.overridingErrorMessage("The attribute with value '%s' is expected NOT to appear in any element on the page "
					+ "but was found in the fragmet '%s'", attribute, elemDesc)
			.isNull();
	}
}
