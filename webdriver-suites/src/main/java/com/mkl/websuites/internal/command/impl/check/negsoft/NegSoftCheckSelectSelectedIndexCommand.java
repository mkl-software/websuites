...
public class NegSoftCheckSelectSelectedIndexCommand extends
		NegCheckSelectSelectedIndexCommand {

	public NegSoftCheckSelectSelectedIndexCommand(
			Map<String, String> parameterMap) {
		super(parameterMap);
	}

	public NegSoftCheckSelectSelectedIndexCommand(String selector,
			String expectedText) {
