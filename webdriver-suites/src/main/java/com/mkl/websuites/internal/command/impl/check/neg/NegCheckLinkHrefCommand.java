...
public class NegCheckLinkHrefCommand extends CheckLinkHrefCommand {
	...
	protected void runSingleStringAssertion(StringAssert assertion,
		...
		assertion
			.overridingErrorMessage("Expecting link with HREF attribute '%s'"
					+ " NOT to exist, but was found for link with text '%s'",
					expectedLinkText, actualElement != null ? actualElement.getText() : "")
			.isNotEqualTo("OK");
	}
}
