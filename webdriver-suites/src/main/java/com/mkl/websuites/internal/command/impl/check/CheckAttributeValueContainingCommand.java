...
public class CheckAttributeValueContainingCommand extends
		CheckAttributeNameCommand {
	...
	protected void runSingleStringAssertion(StringAssert assertion,
		...
		assertion
			.overridingErrorMessage("The attribute with value containing '%s' is expected to appear somewhere on the page "
