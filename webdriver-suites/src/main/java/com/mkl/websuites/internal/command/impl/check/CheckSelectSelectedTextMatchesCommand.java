...
public class CheckSelectSelectedTextMatchesCommand extends CheckSelectSelectedTextCommand {
    ...
    public CheckSelectSelectedTextMatchesCommand(Map<String, String> parameterMap) {
        super(parameterMap);
    }

    public CheckSelectSelectedTextMatchesCommand(String selector, String expectedText) {
        ...
        protected void runSingleStringAssertion(StringAssert assertion, String foundText) {
            ...
            assertion
                    .overridingErrorMessage(
                            "Expecting selected option matching regexp '%s' in the SELECT element picked by "
