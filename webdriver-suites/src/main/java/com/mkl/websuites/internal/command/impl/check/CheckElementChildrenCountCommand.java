...
public class CheckElementChildrenCountCommand extends CheckElementsCountCommand {
	...
	public CheckElementChildrenCountCommand(String selector,
	...
	protected class CheckChildrenCount extends AbstractSingleStringCheck {
		...
		protected String getStringParam() {
			...
			List<WebElement> elements =
					CheckElementChildrenCountCommand.this.foundElement.findElements(directChildren);
		...
		protected void runSingleStringAssertion(StringAssert assertion, String actualNumberOfElements) {
			...
			assertion
				.overridingErrorMessage("Expecting number of direct children of element picked by "
						+ "selector '%s' to be %s but was %s",
						by, expectedNumberOfElements, actualNumberOfElements)
