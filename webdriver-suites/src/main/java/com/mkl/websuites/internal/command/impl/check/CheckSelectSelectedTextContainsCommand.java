...
public class CheckSelectSelectedTextContainsCommand extends CheckSelectSelectedTextCommand {
	...
	public CheckSelectSelectedTextContainsCommand(
			Map<String, String> parameterMap) {
		super(parameterMap);
	}

	public CheckSelectSelectedTextContainsCommand(String selector,
			String expectedText) {
	...
	protected class CheckSelectSelectedTextContains extends CheckSelectSelectedText {
		...
		protected void runSingleStringAssertion(StringAssert assertion, String foundText) {
			...
			assertion
				.overridingErrorMessage("Expecting selected option containing text '%s' in the SELECT element picked by "
