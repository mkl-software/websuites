...
public class NegCheckSelectOptionTextMatchingCommand extends
		CheckSelectOptionTextMatchingCommand {

	public NegCheckSelectOptionTextMatchingCommand(
			Map<String, String> parameterMap) {
		super(parameterMap);
	}

	public NegCheckSelectOptionTextMatchingCommand(String selector,
			String expectedText) {
		...
		protected void runSingleStringAssertion(StringAssert assertion, String foundOption) {
			...
			assertion
				.overridingErrorMessage("Expecting SELECT element picked by selector '%s'"
						+ " NOT to have option matching regexp '%s', but found option '%s'",
