...
public class NegCheckLinkHrefContainingCommand extends
	...
	protected void runSingleStringAssertion(StringAssert assertion,
		...
		assertion
			.overridingErrorMessage("Expecting link with HREF attribute containing '%s'"
					+ " NOT to exist, but found href='%s' in the link with text '%s'",
					expectedLinkText, actualHref, actualLinkText)
			.isNull();
	}
