...
public class NegCheckCssCommand extends CheckCssCommand {
	...
	public NegCheckCssCommand(String selector, String cssAttName,
	...
	protected class NegCheckCss extends CheckCss {
		...
		protected void runSingleStringAssertion(StringAssert assertion,
			...
			assertion
				.overridingErrorMessage("Expecting CSS attribute '%s' on the web page element with selector '%s'"
						+ " NOT to have value '%s'", cssAttributeName, by, expectedCssAttributeValue)
				.isNotEqualTo(expectedCssAttributeValue);
		}
