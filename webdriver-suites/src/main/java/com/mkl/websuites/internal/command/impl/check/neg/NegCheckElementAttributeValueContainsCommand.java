...
public class NegCheckElementAttributeValueContainsCommand extends CheckElementAttributeValueContainsCommand {

    public NegCheckElementAttributeValueContainsCommand(Map<String, String> parameterMap) {
        super(parameterMap);
    }

    public NegCheckElementAttributeValueContainsCommand(String selector, String attributeName,
        ...
        protected void runSingleStringAssertion(StringAssert assertion, String elementText) {
            ...
            assertion.overridingErrorMessage(
                    "Expecting value of attribute '%s' in the web page element with selector '%s'"
                            + " NOT to contain '%s'", inputAttributeName, by, expectedAttributeValue).doesNotContain(
