...
import static com.mkl.websuites.itests.web.core.TestUtils.checkIfNoFailures;
...
public class RepeatDetailedIntegrationTest {
    ...
    @WebSuites(scenarios = @ScenarioFile(""), // will be set dynamically
            browsers = "none")
    ...
    public void shouldRunRepeatInSubtestRepeatScn07() throws Throwable {
        ...
        assertThat(result.getRunCount()).isEqualTo(BASE_RUN_COUNT_FOR_NONE_BROWSER_TEST + 4); // 4
                                                                                              // param
                                                                                              // cases
    ...
    public void shouldRunCommandsBeforeSubtestRepeatScn08() throws Throwable {
        ...
        assertThat(result.getRunCount()).isEqualTo(BASE_RUN_COUNT_FOR_NONE_BROWSER_TEST + 2); // 1
                                                                                              // for
                                                                                              // command
                                                                                              // before
                                                                                              // +
    ...
    public void shouldRunCommandsAfterSubtestRepeatScn09() throws Throwable {
        ...
        assertThat(result.getRunCount()).isEqualTo(BASE_RUN_COUNT_FOR_NONE_BROWSER_TEST + 3); // 2
                                                                                              // param
                                                                                              // case
                                                                                              // + 1
                                                                                              // for
    ...
    public void shouldRunCommandsBeforeAndAfterSubtestRepeatScn10() throws Throwable {
        ...
        assertThat(result.getRunCount()).isEqualTo(BASE_RUN_COUNT_FOR_NONE_BROWSER_TEST + 5); // 1
                                                                                              // for
                                                                                              // command
                                                                                              // before
                                                                                              // + 3
