...
@BrowsersDefinition(browsers = {
        @BrowserConifg(browserType = BrowserType.INTERNET_EXPLORER, id = "ie", displayName = "Internet Explorer",
                webDriverPath = "src/test/resources/drivers/IEDriverServer.exe"),
        @BrowserConifg(browserType = BrowserType.CHROME, id = "chrome", displayName = "Chrome",
