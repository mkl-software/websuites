...
public class IfControlFlowHandlerTest {
    ...
    public void shouldDoIfWhenBrowserDoesNotMatcheWithinSet(@Mocked final Command command,
        ...
        expectCommandRunCountForBrowserConfig(command, browserController, "browserNotIn", "ff,chrome,ie", "safari", 1);
    }
    ...
    private void runPropertyConditionTestFor(String conditionType, String conditionValue, String propertyValue,
            final boolean shouldRun, final Command command) {
        // given
    ...
    @Parameters(value = {"...,abc,true", "...,123,true", "...,1234,false", "\\d\\d,23,true", "\\d\\d,2f,false",
            "set.*,setPropertyShouldMatch,true", "get.*,setDoesntMatch,false",
    ...
    private void expectCommandRunCountForBrowserConfig(final Command command,
            StandardBrowserController browserController, String configParam, String expectedBrowser,
            String actualBrowser, final int expectedRunCount) {
